...
const dialogs = projects
  ...
  .join("");
const experience = `<div class="experience-item"><div class="company-icon"><img src="/assets/oracle.png" alt="Oracle" width="44" height="44" loading="lazy" /></div><div><div class="experience-heading"><h3>Oracle</h3><time datetime="2024-09">September 2024–present</time></div><p>Software Engineer · OCI</p><p class="experience-detail">I build cloud infrastructure and backend services at Oracle. My work includes a WebLogic-to-Spring Boot migration that cut full ETL runtime from four hours to one, and coordinating with application owners to move services onto a new Kubernetes cluster.</p><p class="experience-recognition">Received Oracle’s Gold Award for team-level initiatives and delivery.</p></div></div><div class="experience-item"><div class="company-icon berkeley" aria-hidden="true">Cal</div><div><h3>University of California, Berkeley</h3><p>B.A. Computer Science · 2024</p></div></div>`;
