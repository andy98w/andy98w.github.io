...
- `academis-demo.mp4` and `academis-demo.jpg`: Short Academis walkthrough recorded and supplied by Andy. The delivery copy is a 1440-pixel-wide, 30 fps H.264 encode with fast-start enabled; the poster frame is extracted from the opening AP Economics view.
